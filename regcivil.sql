...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-07-2021 a las 03:15:11
...
(3, 'Karina', 'no se', 'Femenino', '1996-01-19', '99', 'Fraccionamiento las americas', 'default.png', '', 1, 8, 1),
...
--
ALTER TABLE `file`
  MODIFY `idfile` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
...
--
ALTER TABLE `notifications`
  MODIFY `idnotifications` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT de la tabla `office`
--
ALTER TABLE `office`
  MODIFY `idoffice` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
